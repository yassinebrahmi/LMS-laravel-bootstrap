...
<main>
    <section id="hero_in" class="general">
        <div class="wrapper">
            <div class="container">
                <h1 class="fadeInUp" style="color:#008f98"><span></span>WORKSPACE</h1>
            </div>
        </div>
    </section>
    <!--/hero_in-->
    ...
    <div class="container margin_120_95">
        <div class="main_title_2">
            <span><em></em></span>
            <h2 style="color:#008f98">WORKSPACE</h2>
        ...
        <div class="container">
            <h6 style=" text-align: justify;">
                ...
                Nous vous offrons un espace de travail confortable et bien équipé avec un accès flexible allant jusqu’à 24h/24h 7j/7j .
                Si vous êtes freelancer, entrepreneur ou employé, vous aurez un lieu où vous pouvez travailler et développer votre activité dans un environnement à la fois professionnel et convivial.

            </h6>
            <div class="row">
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky1.jpg')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky2.jpg')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky3.jpg')}}" class="img-fluid rounded">
                </a>
            </div>
            <div class="row">
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky4.png')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky5.jpg')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky6.jpg')}}" class="img-fluid rounded">
                </a>
            </div>
            <div class="row">
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky7.jpg')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky8.png')}}" class="img-fluid rounded">
                </a>
                <a href="" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
                    <img src="{{asset('img/coworky9.png')}}" class="img-fluid rounded">
                </a>
            </div>
        </div>
