...
<header class="header fadeInDown">
    ...
    <ul id="top_menu">
        ...
        <a href="/order/cart" class="text-light" style="font-size: 1.2em" data-toggle="tooltip" data-placement="left"
           title="" data-original-title="View my cart">
            <i class="icon-cart ml-3 mr-3 mr-1"></i></a>
        <button type="button" class="btn-dropdown btn-white dropdown-toggle ml-3 p-1 text-light"
                style="background-color: #FFC10700; box-shadow: transparent;outline-style: none;border-width: 0px;"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('img/wissal.jpg')}}"
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="box_cart">
                        <div class="payment_method">
                            <h3><input type="radio" name="payment_method" value="gpg" checked="">
                                <img src="{{asset('img/poste.png')}}" height="60px">&nbsp;E-Dinar Card (La Poste) <br>
                            </h3>
                            <h3><input type="radio" name="payment_method" value="ctp">
                                <img src="{{asset('img/visa.png')}}" height="60px">&nbsp;Credit Card Visa
                            </h3>
                            <h3><input type="radio" name="payment_method" value="ctp">
                                <img src="{{asset('img/mastercard.png')}}" height="60px">&nbsp; Credit Card Mastercard<br>
                            </h3>
                        </div>
                ...
                <aside class="col-lg-4" id="sidebar">
                    <div class="box_detail text-center">
                        ...
                        <img src="{{asset('img/ClicToPay_logo.png')}}" height="50px"><hr/>
                        <a href="cart-2.html" class="btn_1 full-width">Paiement</a>
                    </div>
                </aside>
            </div>
            <!-- /row -->
    ...
    <div class="container margin_120_95">
        <div class="row">
            <div class="col-lg-5 col-md-12 p-r-5">
                ...
                <p>
                    Coworky est une plateforme en ligne spécialisée dans la vente de cours en vidéo. Grâce à
                    Coworky.org, vous allez pouvoir apprendre tout ce que vous voulez et celà peu importe où vous vous
                    situez.
                </p>
                <div class="follow_us">
                    <ul>
                    ...
                    <form method="post" action="{{route('news-letter')}}" name="newsletter_form" id="newsletter_form">
                        ...
                        <div class="form-group">
                            <input type="email" name="email_newsletter" id="email_newsletter" class="form-control"
                                   placeholder="Votre Aderesse mail">
