...
@section('contenu')
    ...
    <div class="box_general padding_bottom">
            ...
            <div class="col-md-8 add_top_30">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="catalogue" id="catalogue" required>
                                <option value="{{$module->catalogue_id}}" selected>{{$module->catalogue->nomtheme}}</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Titre :*</label>
                            <input type="text" class="form-control" placeholder="Titre Module" required name="name" id="name" value="{{$module->name}}">
                        </div>
                    </div>
                </div>
                <!-- /row-->
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" style="height:100px;" class="form-control" placeholder="Déscription">{{$module->description}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
        ...
        <div class="header_box version_2">
            ...
            <input type="hidden" name="idm"  id="idm" required value="{{$module->id}}">
...
@push('js')
    ...
    <script src="{{asset('vendor/dropzone1.js')}}"></script>
